...
########################################
########################################
This is a copy of the original gui.py from the pyroute project
Changes made by Michael Pilgermann (michael.pilgermann@gmx.de)

Changes were applied in order to make it running with the GLS extension
...
- end comment Michael Pilgermann - 
########################################
########################################
"""
#-----------------------------------------------------------------------------
...
# change michael pilgermann
from pyroute_pygls import pyglsPoiModule
# end change michael pilgermann
...
# change michael pilgermann
    self.modules['poi']['gls'] = pyglsPoiModule(self.modules, self) # reference to self is required for forcing redraw
# end change michael pilgermann
